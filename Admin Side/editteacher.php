...
<div>
    <form id="searchB" method="POST" action="<?php $_SERVER["PHP_SELF"];?>">
       <input type="text" name="Search"  placeholder="Search for names.." onkeyup="aftersearch.php" >
    </form>
    <form method="POST" action="afterSaveBtn.php"  id="EditTeacher">
      First name: <input name="fname" type="text"  value="<?php echo $Trow1['fname'];?>"><br><br>
      Last Name: <input name="lname" type="text"  value="<?php echo $Trow1['lname'];?>"><br><br>
      SSN: <input name="ssn" type="text"  value="<?php echo $Trow1['ssn'];?>"><br><br>
      Nationality: <input name="nat" type="text"  value="<?php echo $NTrow['name'];?>"><br><br>
      Home Address: <input name="address" type="text"  value="<?php echo $ADrow['name'];?>"><br><br>
      Mobile number: <input name="cellphone" type="text"  value="<?php echo $CIrow['cellphone']; ?>"><br><br>
      Marital Status: <input name="mstatus" type="text"  value="<?php echo $MRrow['value'];?>"><br><br>
      <p>Academic Qualifications with Dates:<br><br></p>
      Qualification 1: <input name="acaqual1" type="text"  value="<?php echo $Trow['acaqual1'];?>">
      <input name="date_acaqual1" type="text"  value="<?php echo $Trow['date_acaqual1'];?>"><br><br>
      <b>Professional Qualifications with Dates:<br><br></b>
      Qualification 1: <input name="personal_qual1" type="text"  value="<?php echo $Trow['personal_qual1'];?>">
      <input name="date_ppersonalqual1" type="text"  value="<?php echo $Trow['date_ppersonalqual1'];?>"><br>
      <br><hr>
      Present Employer's Name: <input name="pempname" type="text"  value="<?php echo $Trow['pempname'];?>"><br><br>
      Present Employer's Address: <input name="pempaddress_id" type="text"  value="<?php echo $ADrow['name'];?>">
      <br><br>
      Present Employer's phone number: <input name="pempnum" type="text"  value="<?php echo $Trow['pempnum'];?>"><br><br><hr>

      Current or Last Salary: <input name="corsalary" type="text"  value="<?php echo $Trow['corlsalary'];?>"><br><br>
      Reqqested Salary: <input name="reqsalary" type="text"  value="<?php echo $Trow['reqsalary'];?>"><br><br>

      Have you been interviewed recently at other nurseries? if yes, please mention names:<br><br>
      <input name="othernursery" type="text"  value="<?php echo $Trow['othernursery'];?>"><br><br>

      In your point of view, how do you see an ideal nursery regarding its academic side?<br><br>
      <input name="povnursery" type="text"  value="<?php echo $Trow['povnursery'];?>"></textarea><br>
      <br><br>
